  ...
  static override forRoot(options: ConfigModuleOptions = {}) {
    ...
    return super.forRoot({
      ...
      envFilePath: [
        ...
        join(process.cwd(),  'libs', 'node-services', 'admin-videos-catalog', 'envs', `.env.${process.env['NODE_ENV']}`),
        join(process.cwd(),  'libs', 'node-services', 'admin-videos-catalog', 'envs', `.env`),
      ],
